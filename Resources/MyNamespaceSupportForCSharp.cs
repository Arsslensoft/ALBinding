...
// This file was created by the VB to AL converter (SharpDevelop ${Version}).
// It contains classes for supporting the VB "My" namespace in AL.
// If the VB application does not use the "My" namespace, or if you removed the usage
// after the conversion to AL, you can delete this file.
